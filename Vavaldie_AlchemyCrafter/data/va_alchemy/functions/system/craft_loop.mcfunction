...
data modify entity @e[tag=vaAlc_ReleaseItemS,distance=..0.1,limit=1] Item set from entity @s item.tag.va.Product_List[0]
data remove entity @s item.tag.va.Product_List[0]
